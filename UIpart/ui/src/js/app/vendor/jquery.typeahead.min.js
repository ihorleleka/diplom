    ...
    Typeahead.prototype = {
        ...
        navigate: function (e) {
            ...
            if (activeItem.length > 0) {
                ...
                itemIndex && this.node.val(this.result[itemIndex].CountryName);
                ...
                for (var k = 0; k < this.source[group].length; k++) {
                    ...
                    for (var i = 0; i < displayKeys.length; i++) {
                        ...
                        if (filter) {
                            ...
                            if (this.options.predictedHandler && this.options.predictedHandler(comparedDisplay)) {
                        ...
                        if (this.resultItemCount < this.options.maxItem) {
                            ...
                            item.matchedKey = 'CountryName'; //displayKeys[i];
