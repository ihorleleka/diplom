...
$topicId = $_POST['id'];
$category = mysql_query("SELECT * FROM `subcategories` WHERE `id` = '$topicId' LIMIT 1") or die(mysql_error());
...
mysql_query("DELETE FROM `subcategories` WHERE `id` = '$topicId' LIMIT 1") or die(mysql_error());
