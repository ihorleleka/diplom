...
$categoryId = $_POST['id'];
$category = mysql_query("SELECT * FROM `categories` WHERE `id` = '$categoryId' LIMIT 1") or die(mysql_error());
...
mysql_query("DELETE FROM `categories` WHERE `id` = '$categoryId' LIMIT 1") or die(mysql_error());
